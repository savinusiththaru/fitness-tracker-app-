...
class HeightScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      title: 'Height Screen Example',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: const _HeightScreenState(),
    );
  }
}

class _HeightScreenState extends StatefulWidget {
  const _HeightScreenState();

  @override
  State<_HeightScreenState> createState() => HeightScreenState();
}

class HeightScreenState extends State<_HeightScreenState> {
  double _selectedHeight = 165; // Default height set to 165 cm
                      ...
                      children: [
                        OutlinedButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(builder: (context) => const GenderScreen()), // Navigate to previous screen
                            );
                          },
